...
namespace ToDoList.Infra.Data.Migrations
{
    ...
    [Migration("20240229000216_relate card with user")]
    partial class relatecardwithuser
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ToDoList.Domain.Entities.Card", b =>
                {
                    ...
                    b.HasIndex("ApplicationUserId")
                        .HasDatabaseName("ix_card_application_user_id");
            ...
            modelBuilder.Entity("ToDoList.Domain.Entities.Card", b =>
                {
                    b.HasOne("ToDoList.Infra.Data.Identity.ApplicationUser", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_card_users_application_user_id");
                });
